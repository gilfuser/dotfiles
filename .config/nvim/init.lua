...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'lua', 'python', 'typescript', 'help', 'supercollider', 'kdl' },

  highlight = { enable = true, disable = { 'python', 'supercollider', 'lua' } },
  indent = { enable = true, disable = { 'python', 'supercollider', 'lua' } },
