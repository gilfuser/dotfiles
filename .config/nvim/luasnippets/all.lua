...
return { 
	-- s(
	-- { trig = "d1", snippetType = "autosnippet" }, fmta(
	-- 	[[
	-- 	SynthDef(\<>, { | out <> <> <> |
	-- 		<><>
	-- 		<><>
	...
	-- 	]],
	-- 	{
	-- 		c(1, { f(choose_name), i(1,"") }),
	-- 		sn(2, { i(1, "freq="), c(2, { f(random_freq), i(1,"") } ) } ), i(3, "sustain=1"),
	-- 		i(4, "amp=0.2"),
	-- 		i(5, "sig = "), i(6, "SinOsc.ar(freq);"),
	-- 		i(7, "env = "), i(8, "Env.new().kr(2, sustain, gate);"),
	-- 		i(9),
	-- 		i(10, "OffsetOut.ar(out, sig*amp*env);"),i(0)
	--
	-- 	}
	...
	s("nset",
		{ t("~"), i(1), t("["), i(2, "2"), t("] = \\set -> { Pbind ( "), i(3), t("\\dur, "), i(4, "1"), t(", "), i(0),
			t(" ) }"),
	}),
